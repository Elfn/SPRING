...
import com.mobile.ws.app.SpringApplicationContext;
import com.mobile.ws.app.service.UserService;
import com.mobile.ws.app.shared.dto.UserDto;
import com.mobile.ws.app.ui.model.request.UserLoginRequestModel;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	protected void successfulAuthentication(HttpServletRequest req, HttpServletResponse res, FilterChain chain,
		...
		// Here we get user specific-data to put in JWT SUBJECT
