...
public class IngredientController {
    ...
    public String showRecipeIngredient(@PathVariable String recipeId,
        ...
        model.addAttribute("ingredient", ingredientService.findByRecipeIdAndIngredientId(recipeId, ingredientId));//"block()" subscribes to this Mono and block indefinitely until a next signal is received;
    ...
    public String saveOrUpdate(@ModelAttribute("ingredient") IngredientCommand command, @PathVariable String recipeId){
        ...
        return REDIRECT_RECIPE + savedCommand.getRecipeId()+ "/ingredient/" + savedCommand.getId() + "/show";
    }
    ...
    public String deleteIngredient(@PathVariable String recipeId,
        ...
        return REDIRECT_RECIPE + recipeId + "/ingredients";
    }
