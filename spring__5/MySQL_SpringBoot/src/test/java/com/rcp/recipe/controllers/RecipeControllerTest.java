...
/**
 * Created by Elimane on Nov, 2017, at 13:57
 */
public class RecipeControllerTest {
    ...
    private static final String VIEW_NAME = "recipe/recipeForm";
    ...
    public void setUp() {
        ...
        //Here we are building the entry point to server side spring mvc test(MOCKMVC)
    ...
    public void showById() throws Exception {
        ...
        when(recipeService.findById(anyLong())).thenReturn(rcp);

        //get access to server's service in order to test it
...
//        when(recipeService.findById(anyLong())).thenThrow(NumberFormatException.class);
        ...
        mockMvc.perform(get("/recipe/show/ANVC"))
